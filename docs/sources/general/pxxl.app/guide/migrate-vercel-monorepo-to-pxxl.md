# Source: https://pxxl.app/guide/migrate-vercel-monorepo-to-pxxl

How-to Guide6 min read2026-06-04

# How to Migrate a Next.js / Turbo Monorepo from Vercel to Pxxl
...
## Step-by-Step Turborepo / Monorepo Setup Migration from Vercel

To migrate your Turborepo / Monorepo Setup application, follow these steps: 1. Export any secrets or check environment variables on your Vercel dashboard. 2. In Pxxl, go to "New Project" -> select "Vercel" as your import provider. 3. Authenticate using your Personal Access Token (Vercel Account Settings -> Tokens). Pxxl will fetch your services list. 4. Select the project hosting your Turborepo / Monorepo Setup app. 5. Pxxl auto-detects that this is a Turborepo / Monorepo Setup project. It imports your GitHub repository connection, branch configurations, build commands, and environment variables. 6. For monorepos, specify the root directory of the sub-project in the project settings during import. Pxxl supports build caching, enabling you to build only the packages that have changed, matching Vercel's monorepo speed without the USD pricing. 7. Set up your routing (Pxxl automatically provides a free \*.pxxl.app subdomain, or you can bind a custom domain like .com.ng in minutes with free SSL). 8. Click "Create Project". Pxxl builds and deploys your service. Once verified, update your DNS settings or third-party integrations to complete the migration.
...
monorepoturborepovercelnextjsdevops
