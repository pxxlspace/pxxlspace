# Source: https://pxxl.app/guide/how-to-integrate-pxxl-domain-api-nodejs

How-to Guide7 min read2026-05-28

# How to Integrate Pxxl Domain Reseller API into a NodeJS Application
...
## Setting Up Your NodeJS Project and API Route Handler

Start by setting up a fresh NodeJS project. To keep your reseller API key secure, create a server-side route handler that acts as a proxy. This ensures your client-side code never exposes the Bearer token used to authenticate with Pxxl.
...
domain apiintegrationtutorialdeveloper toolsnodejs
