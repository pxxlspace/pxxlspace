# Source: https://pxxl.app/guide/migrate-vercel-vite-react-to-pxxl

How-to Guide8 min read2026-06-04

# Migrate Vite + React Projects from Vercel to Pxxl (Always-On Free Hosting)
...
## Step-by-Step Vite React SPA Migration from Vercel

To migrate your Vite React SPA application, follow these steps: 1. Export any secrets or check environment variables on your Vercel dashboard. 2. In Pxxl, go to "New Project" -> select "Vercel" as your import provider. 3. Authenticate using your Personal Access Token (Vercel Account Settings -> Tokens). Pxxl will fetch your services list. 4. Select the project hosting your Vite React SPA app. 5. Pxxl auto-detects that this is a Vite React SPA project. It imports your GitHub repository connection, branch configurations, build commands, and environment variables. 6. Since Vite React is a static Single Page Application (SPA), ensure the output directory matches your Vite output (typically "dist" or "build"). Pxxl serves your static files from local edge caches, resulting in incredibly fast load times for West African visitors. 7. Set up your routing (Pxxl automatically provides a free \*.pxxl.app subdomain, or you can bind a custom domain like .com.ng in minutes with free SSL). 8. Click "Create Project". Pxxl builds and deploys your service. Once verified, update your DNS settings or third-party integrations to complete the migration.
...
reactvitevercelfree tiernigeria
