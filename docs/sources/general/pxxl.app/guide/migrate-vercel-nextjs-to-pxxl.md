# Source: https://pxxl.app/guide/migrate-vercel-nextjs-to-pxxl

How-to Guide8 min read2026-06-04

# How to Migrate a Next.js App from Vercel to Pxxl (2026 Guide)
...
## Step-by-Step Next.js App Migration from Vercel

To migrate your Next.js App application, follow these steps: 1. Export any secrets or check environment variables on your Vercel dashboard. 2. In Pxxl, go to "New Project" -> select "Vercel" as your import provider. 3. Authenticate using your Personal Access Token (Vercel Account Settings -> Tokens). Pxxl will fetch your services list. 4. Select the project hosting your Next.js App app. 5. Pxxl auto-detects that this is a Next.js App project. It imports your GitHub repository connection, branch configurations, build commands, and environment variables. 6. Pxxl natively supports Next.js routing, SSR (Server-Side Rendering), API Routes, and Middleware. During import, verify that the Next.js framework preset is active. Set your environment variables (like DATABASE\_URL or NEXT\_PUBLIC\_API\_URL). Pxxl will automatically configure the build cache to accelerate future builds. 7. Set up your routing (Pxxl automatically provides a free \*.pxxl.app subdomain, or you can bind a custom domain like .com.ng in minutes with free SSL). 8. Click "Create Project". Pxxl builds and deploys your service. Once verified, update your DNS settings or third-party integrations to complete the migration.
...
vercelnextjsmigrationnaira pricingpaystack
