...
<AccordionGroup>
  ...
  <Accordion title="Enable WebSocket support">
    ...
    <Steps>
      <Step title="Open the domain">
        Go to [Domains](/domains/overview) and select the domain your realtime app is connected to.
      </Step>
  ...
  <Accordion title="Protect upstreams with circuit breaker and retries">
    ...
    **Setup steps**
    ...
    <Steps>
      <Step title="Open the domain">
        Go to [Domains](/domains/overview) and select the domain connected to the project you want to protect.
      </Step>
      <Step title="Open Settings">
        Click the **Settings** tab.
      </Step>
