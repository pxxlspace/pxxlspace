...
<AccordionGroup>
    ...
    **Fix steps**
    ...
    <Steps>
      ...
      <Step title="Resync the proxy">
        Open [Domains](/domains/overview), select the domain, and click **Resync Proxy**. This tells the edge to re-read the route and create a certificate request for the hostname.
      </Step>
  ...
  <Accordion title="Domain shows 503">
    ...
    **Fix steps**
    ...
    <Steps>
      ...
      <Step title="Resync the proxy">
        Open [Domains](/domains/overview), select the domain, and click **Resync Proxy** so the edge picks up the updated upstream target. Redeploy only if the app image itself needs a changed port or config value.
      </Step>
    </Steps>
  </Accordion>
    ...
    **Fix steps**
    ...
    <Steps>
      <Step title="Open the domain">
        Go to [Domains](/domains/overview) and select the affected domain.
      </Step>
  ...
  <Accordion title="Connect a domain to a project">
    ...
    **From the domain**
    ...
    <Steps>
      <Step title="Open the domain">
        Go to [Domains](/domains/overview) and select the domain.
      </Step>
  ...
  <Accordion title="After buying a domain on Pxxl">
    ...
    <Steps>
      <Step title="Open the domain detail page">
        Go to [Domains](/domains/overview) and click the new domain.
      </Step>
